...
DROP TABLE IF EXISTS cinema.booking_approval CASCADE;

CREATE TABLE cinema.booking_approval
(
    id uuid NOT NULL,
...
DROP MATERIALIZED VIEW IF EXISTS cinema.booking_cinema_m_view;

CREATE MATERIALIZED VIEW cinema.booking_cinema_m_view
...
refresh materialized VIEW cinema.booking_cinema_m_view;

DROP function IF EXISTS cinema.refresh_booking_cinema_m_view;

CREATE OR replace function cinema.refresh_booking_cinema_m_view()
returns trigger
AS '
BEGIN
    refresh materialized VIEW cinema.booking_cinema_m_view;
...
DROP trigger IF EXISTS refresh_booking_cinema_m_view ON cinema.cinema_movies;

CREATE trigger refresh_booking_cinema_m_view
after INSERT OR UPDATE OR DELETE OR truncate
ON cinema.cinema_movies FOR each statement
EXECUTE PROCEDURE cinema.refresh_booking_cinema_m_view();